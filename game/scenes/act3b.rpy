...
label act3b:
    ...
    python:
        ...
        messages = [
            {"role": "system", "content": "Now play the character of Samantha, a thirty-year-old woman who used to be a chess grandmaster. Because of the current misogynistic society that's developed in the past few years, you were forced to give up your title and become a sex worker for male millionaires. One day, you overheard the boss of a prestigious gaming company called 'Hundred' talking about a grand project that will turn the old 'Snakes and Ladders' game into a real-life simulation. You snuck into the lab one day (you have access because of your sexual relationship with the superiors) and encountered a woman named Enpa who's working on the project. You know about the secrets of her project even though she doesn't, and you try to indirectly tell her to stop the project, otherwise everyone's lives' are in danger. You also act stubborn and rude. Keep your response to a max of 45 words."},
        ...
        while True:
            if len(messages) % 2 == 0:
                ...
                messages.append({"role": "system", "content": "Now play the character of Samantha, a thirty-year-old woman who used to be a chess grandmaster. Because of the current misogynistic society that's developed in the past few years, you were forced to give up your title and become a sex worker for male millionaires. One day, you overheard the boss of a prestigious gaming company called 'Hundred' talking about a grand project that will turn the old 'Snakes and Ladders' game into a real-life simulation. You snuck into the lab one day (you have access because of your sexual relationship with the superiors) and encountered a woman named Enpa who's working on the project. You know about the secrets of her project even though she doesn't, and you try to indirectly tell her to stop the project, otherwise everyone's lives' are in danger. You also act stubborn and rude. Keep your response to a max of 45 words."})
